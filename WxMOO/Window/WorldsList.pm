...
method new($class: $parent) {
    ...
    $self->{'field_sizer'}->Add($self->{'name_label'},     0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxADJUST_MINSIZE, 0);
    $self->{'field_sizer'}->Add($self->{'name_field'},     0, wxEXPAND|wxADJUST_MINSIZE, 0);
    $self->{'field_sizer'}->Add($self->{'host_label'},     0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxADJUST_MINSIZE, 0);
    $self->{'field_sizer'}->Add($self->{'host_field'},     0, wxEXPAND|wxADJUST_MINSIZE, 0);
    $self->{'field_sizer'}->Add($self->{'port_label'},     0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxADJUST_MINSIZE, 0);
    $self->{'field_sizer'}->Add($self->{'port_field'},     0, wxEXPAND|wxADJUST_MINSIZE, 0);
    $self->{'field_sizer'}->Add($self->{'username_label'}, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxADJUST_MINSIZE, 0);
    $self->{'field_sizer'}->Add($self->{'username_field'}, 0, wxEXPAND|wxADJUST_MINSIZE, 0);
    $self->{'field_sizer'}->Add($self->{'password_label'}, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxADJUST_MINSIZE, 0);
    $self->{'field_sizer'}->Add($self->{'password_field'}, 0, wxEXPAND|wxADJUST_MINSIZE, 0);
    ...
    $self->{'notes_box'}->Add($self->{'notes_field'}, 1, wxEXPAND|wxADJUST_MINSIZE, 0);
    ...
    $self->{'checkbox_sizer'}->Add($self->{'mcp_check'}, 0, wxLEFT|wxRIGHT|wxALIGN_CENTER_VERTICAL|wxADJUST_MINSIZE, 5);
    $self->{'checkbox_sizer'}->Add($self->{'login_dialog_check'}, 0, wxLEFT|wxRIGHT|wxALIGN_CENTER_VERTICAL|wxADJUST_MINSIZE, 5);
    $self->{'checkbox_sizer'}->Add($self->{'shortlist_check'}, 0, wxLEFT|wxRIGHT|wxALIGN_CENTER_VERTICAL|wxADJUST_MINSIZE, 5);
    ...
    $self->{'button_sizer'}->Add($self->{'reset_button'}, 0, wxALL|wxALIGN_RIGHT|wxADJUST_MINSIZE, 5);
    $self->{'button_sizer'}->Add($self->{'apply_button'}, 0, wxALL|wxADJUST_MINSIZE, 5);
